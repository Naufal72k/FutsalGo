...
public class DashboardAdmin extends JPanel {
    ...
    // Method untuk membuat Dashboard Panel
    ...
    // Method untuk membuat Manage Fields Panel
    private JPanel createManageFieldsPanel() {
        ...
        addBtn.addActionListener(e -> showAddFieldDialog());
    ...
    private void showAddFieldDialog() {
        ...
        saveBtn.addActionListener(e -> {
            ...
            if (!name.isEmpty()) {
                JOptionPane.showMessageDialog(dialog, "Field added successfully!");
                dialog.dispose();
            } else {
    ...
    // Method untuk membuat Manage Bookings Panel
    ...
    // Method untuk membuat Users Panel
    ...
    // Method untuk membuat Transactions Panel
    ...
    // Method untuk membuat Settings Panel
