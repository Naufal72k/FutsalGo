...
public class Tema {
    ...
    // Font styles
    final public Font FONT_BOLD_12 = new Font("Poppins", Font.BOLD, 12);
    final public Font FONT_BOLD_14 = new Font("Poppins", Font.BOLD, 14);
    final public Font FONT_BOLD_20 = new Font("Poppins", Font.BOLD, 20);
    final public Font FONT_BOLD_24 = new Font("Poppins", Font.BOLD, 24);
    
    final public Font FONT_REGULER_12 = new Font("Poppins", Font.PLAIN, 12);
    final public Font FONT_REGULER_14 = new Font("Poppins", Font.PLAIN, 14);
    final public Font FONT_REGULER_16 = new Font("Poppins", Font.PLAIN, 16);
    
    // Resolusi dan ukuran tampilan
    final public int lebar = 1280;
    final public int tinggi = 720;
